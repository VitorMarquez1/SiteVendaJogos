...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getFormData() {
        const isGame = formElements.category.value === 'jogo';
        return {
            ...
            // Se for jogo, estoque é indefinido (ou nulo), senão, pega o valor
            stock: isGame ? null : parseInt(formElements.stock.value), 
            category: formElements.category.value,
            genre: formElements.genre.value,
            type: formElements.type.value,
            platform: formElements.platform.value,
            featured: formElements.featured.checked,
            reviews: []
        };
    }
    ...
    // ALTERADO: Função agora também controla o campo de estoque
    function toggleCategoryFields() {
        ...
        document.getElementById('stock-group').style.display = !isGame ? 'block' : 'none';

        // Torna o campo de estoque não-obrigatório se for um jogo
        document.getElementById('stock').required = !isGame;
    }
